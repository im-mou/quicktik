...
const TimeAndTasksStats = ({ pendingTasksCount, completedTasksCount, remainingTime }: ITimeAndTasksStats) => {
    return (
        <div>
            ...
            <Group>
                ...
                <Separator />
                <Text size="xs" color="dimmed">
                    {remainingTime?.hours}h {remainingTime?.minutes}minutes remaining
                </Text>
            </Group>
        </div>
    );
